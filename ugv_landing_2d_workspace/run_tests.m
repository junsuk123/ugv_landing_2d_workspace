...
tests = {@test_baseline_equivalence,@test_pn_guidance,@test_observation_boundary, ...
    @test_speed_segments,@test_monte_carlo_evaluation,@test_config_validation, ...
    @test_reward_transition,@test_recovery_diagnostics, ...
    ...
    @test_ontology_view_model};
if includeGraphics
    tests = [tests,{@test_segment_background,@test_plot_export,@test_ontology_view_tab}];
end
