...
%% 학습 조건
% false면 제안 모델이 기준 모델과 완전히 같은 rl 설정(모방 학습 포함, 같은 시드,
% 같은 반복 수)으로 학습합니다. 상태 표현만 실험 변수로 두려면 false로 둡니다.
% true면 landing2d.rl.applyScratchSettings를 적용합니다(옛 온톨로지 비교군 조건).
gs.useScratchSettings = false;
